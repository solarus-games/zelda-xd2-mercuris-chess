...
function map_meta:create_ground_effect(effect, x, y, layer, sound_id)
  ...
  local ground_effect = map:create_custom_entity({direction=0,
    layer=layer, x=x, y=y, width = 16, height = 16, model=model})
...
--]] 
function map_meta:ground_collision(entity, collision_sound)
